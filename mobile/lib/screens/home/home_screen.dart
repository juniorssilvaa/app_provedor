...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    final isSuspended = statusString.contains('SUSPENSO') || statusString.contains('BLOQUEADO');
  ...
  Future<void> _performUnlock(String contractId) async {
    ...
    try {
      ...
      if (result['status'] == 1 || result['liberado'] == true) {
         ...
         if (mounted) {
           ScaffoldMessenger.of(context).showSnackBar(
             SnackBar(content: Text(result['msg']?.toString() ?? 'Erro ao desbloquear'), backgroundColor: const Color(0xFFFF0000))
           );
         }
      }
    } catch (e) {
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
           SnackBar(content: Text('Erro: $e'), backgroundColor: const Color(0xFFFF0000))
        );
      }
    }
  }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [primaryRed.withOpacity(0.1), cardBg],
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.star_rounded, color: primaryRed, size: 32),
          ),
          const SizedBox(width: 16),
          Expanded(
            child: Column(
  ...
  Widget _buildBottomNav(bool isDark) {
    return Stack(
      ...
      children: [
        ...
        Positioned(
          bottom: 40, // Abaixado mais ainda na pílula
      ...
      child: Stack(
        ...
        children: [
          if (isSuspended && !_hideSuspensionGuide)
            Positioned(
              top: 85, // Subido um pouco para dar mais espaço
              left: 0,
              right: 0,
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Stack(
                    ...
                    children: [
                      ...
                      // Botão de fechar (X)
                      Positioned(
                        left: 105, // Mais para a direita
                        top: -18, // Mais para cima
                        child: Material(
                          color: Colors.transparent,
                          child: InkWell(
                            onTap: () {
                            ...
                            child: Container(
                              ...
                              child: Container(
                                ...
                                child: Icon(Icons.close, size: 14, color: primaryRed),
                              ),
                            ),
                          ),
                        ),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: isSuspended 
                        ? [primaryRed, primaryRed] // Red Front
