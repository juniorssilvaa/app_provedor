...
class _AIChatScreenState extends State<AIChatScreen> {
  ...
  Widget _buildInputArea() {
    return Container(
      color: Colors.transparent, // Remove fundo cinza, deixa transparente
      ...
      child: Row(
        children: [
          Expanded(
            child: Container(
              padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 2), // Mais padding interno no campo
              decoration: BoxDecoration(
                color: const Color(0xFF1E1E1E), // Cor do campo de texto (cinza escuro)
          ...
          const SizedBox(width: 12), // Mais espaço entre input e botão
          GestureDetector(
            onTap: _sendMessage,
            child: Container(
              width: 50,
