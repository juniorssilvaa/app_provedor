...
class InAppWarning(models.Model):
    ...
    target_cpfs = models.TextField(blank=True, null=True, help_text='Separados por vírgula')
    target_contracts = models.TextField(blank=True, null=True, help_text='Separados por vírgula')
    created_at = models.DateTimeField(auto_now_add=True)
    active = models.BooleanField(default=True)
