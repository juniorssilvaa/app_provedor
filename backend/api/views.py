...
def get_sgp_integration(request):
    ...
    if provider.webhook_url:
        ...
        # Construindo a URL do webhook - sempre usa api.niochat.com.br em produção
        # Em desenvolvimento, usa uma variável de ambiente ou o host atual
        import os
        webhook_host = os.environ.get('WEBHOOK_HOST', 'api.niochat.com.br')
        ...
        if 'localhost' in host or '127.0.0.1' in host:
            ...
            # Em produção, sempre usa api.niochat.com.br
            scheme = "https"
            webhook_host = "api.niochat.com.br"
            
        # Importante: Todas as rotas da api.urls estão sob o prefixo /api/ no niochat/urls.py
        webhook_url = f"{scheme}://{webhook_host}/api/webhooks/push/"
