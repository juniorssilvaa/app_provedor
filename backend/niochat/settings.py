...
SECRET_KEY = 'django-insecure-acK0Z6lOzI_g0tQhb_Ir9bisTC8dZQrTaoIPgBpmjqRzye1XaVsPBXgF2LbhkkbPPAU'
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://webhooks.niochat.com.br',
    'https://apis.niochat.com.br',
    'https://*.niochat.com.br',
    'https://*.ngrok-free.app',
    'https://cc7a-2804-32bc-a504-2aa0-e889-b56e-f86f-a56.ngrok-free.app',
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'NioChat API',
    'DESCRIPTION': 'Documentação da API para o projeto NioChat',
    'VERSION': '1.0.0',
